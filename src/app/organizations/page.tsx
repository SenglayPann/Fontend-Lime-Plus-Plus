...
export default function OrganizationsPage() {
  const organizations = [
    { id: "1", name: "Engineering Faculty", license: "Enterprise", departments: 8, users: 1200, status: "Active" },
    { id: "2", name: "Science Institute", license: "Academic", departments: 4, users: 450, status: "Active" },
    { id: "3", name: "Tech Bootcamp A", license: "Standard", departments: 1, users: 80, status: "Active" },
    { id: "4", name: "Business School", license: "Trial", departments: 2, users: 150, status: "Expiring" },
  ];
      ...
      <div className="space-y-8">
        ...
        <Card>
                ...
                <tbody className="divide-y divide-border">
                  {organizations.map((org) => (
                    <tr key={org.id} className="hover:bg-muted/20 transition-colors group">
                      ...
                      <td className="px-6 py-4 text-muted-foreground">{org.departments}</td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <span className={cn(
                          ...
                          org.status === "Active" ? "bg-primary/10 text-primary" : "bg-amber-100 text-amber-700"
                        )}>
                          {org.status}
                        </span>
                      </td>
          ...
          <div className="flex items-center justify-between border-t border-border px-6 py-4 bg-muted/10">
            <p className="text-xs text-muted-foreground">Showing 4 of 4 results</p>
            <div className="flex gap-2">
